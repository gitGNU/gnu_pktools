...
public:
  ...
  void filter(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, bool absolute=false, bool normalize=false, bool noData=false);
  void smooth(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output,int dim);
  void smooth(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output,int dimX, int dimY);
  void smoothNoData(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output,int dim);
  void smoothNoData(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output,int dimX, int dimY);
  ...
  void dwtCut(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, const std::string& wavelet_type, int family, double cut, bool verbose=false);
  ...
  void majorVoting(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, int dim=0,const std::vector<int> &prior=std::vector<int>());
  ...
  void doit(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, const std::string& method, int dim, short down=1, bool disc=false);
  void doit(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, const std::string& method, int dimX, int dimY, short down=1, bool disc=false);
  void mrf(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, int dimX, int dimY, double beta, bool eightConnectivity=true, short down=1, bool verbose=false);
  void mrf(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, int dimX, int dimY, Vector2d<double> beta, bool eightConnectivity=true, short down=1, bool verbose=false);
  ...
  void median(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, int dim, bool disc=false);
  void var(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, int dim, bool disc=false);
  void morphology(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, const std::string& method, int dimX, int dimY, const std::vector<double> &angle=std::vector<double>(), bool disc=false);
  ...
  void shadowDsm(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, double sza, double saa, double pixelSize, short shadowFlag=1);
  //  void dwt_texture(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, int dim, int scale, int down=1, int iband=0, bool verbose=false);
  void shift(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, double offsetX=0, double offsetY=0, double randomSigma=0, RESAMPLE resample=BILINEAR, bool verbose=false);
  ...
  void linearFeature(std::shared_ptr<ImgRaster> input, std::shared_ptr<ImgRaster> output, float angle=361, float angleStep=1, float maxDistance=0, float eps=0, bool l1=true, bool a1=true, bool l2=true, bool a2=true, int band=0, bool verbose=false);
