/**********************************************************************
pksvmogr_bin.cc: classify vector dataset using Support Vector Machine
...
/*! \page pksvmogr pksvmogr
  ...
  Options: [-tln layer]* [-c name -r value]* [-f OGRformat] [-co NAME=VALUE]* [-ct filename] [-label attribute] [-prior value]* [-g gamma] [-cc cost]
  ...
  | i      | input                | std::string |       |input dataset |
  | o      | output               | std::string |       |Output classification dataset|
  ...
  Examples
  ========
  Some examples how to use pksvm can be found \ref examples_pksvmogr "here"
**/
...
int main(int argc, char *argv[])
{
  ...
  Optionpk<string> input_opt("i", "input", "input dataset(s)");
  ...
  Optionpk<string> output_opt("o", "output", "Output dataset(s)");
