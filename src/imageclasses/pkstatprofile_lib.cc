 ...
 * @return output image
 **/
shared_ptr<ImgRaster> ImgCollection::statProfile(const AppFactory& app){
  try{
    // shared_ptr<ImgRaster> imgWriter=front()->createImg();
 ...
 **/
CPLErr ImgCollection::statProfile(ImgRaster& imgWriter, const AppFactory& app){
